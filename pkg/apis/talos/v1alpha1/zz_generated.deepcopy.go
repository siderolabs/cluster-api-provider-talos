...
func (in *TalosClusterMastersSpec) DeepCopyInto(out *TalosClusterMastersSpec) {
	*out = *in
	if in.IPs != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TalosClusterMastersSpec.
func (in *TalosClusterMastersSpec) DeepCopy() *TalosClusterMastersSpec {
	if in == nil {
		return nil
	}
	out := new(TalosClusterMastersSpec)
	in.DeepCopyInto(out)
	return out
}

...
// TalosMachineProviderStatus is the Schema for the talosmachineproviderstatuses API
...
func init() {
	SchemeBuilder.Register(&TalosMachineProviderStatus{}, &TalosMachineProviderStatusList{})
}
